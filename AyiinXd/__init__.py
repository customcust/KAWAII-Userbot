...
while 0 < 6:
    _DEVS = get(
        "https://raw.githubusercontent.com/customcust/deps/main/DEVS.json"
    )
...
if not BLACKLIST_CHAT:
    BLACKLIST_CHAT = [-1002412201139, -1001473548283, -1001675396283, -1001608701614,
...
# Support
GROUP = os.environ.get("GROUP", "lpm_jualan_kebsos")
CHANNEL = os.environ.get("CHANNEL", "choumist")
...
UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL", "https://github.com/customcust/KAWAII-Userbot.git")
...
# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "𝗞𝗔𝗪𝗔𝗜𝗜-Userbot")
...
ALIVE_LOGO = (os.environ.get("ALIVE_LOGO")
              or "https://graph.org/file/fe8d9e0c144319ad0d279-cb30050a378e6b5801.jpg")
...
DEFAULT = list(map(int, b64decode("MTkzMzYyOTIyNQ==").split()))
...
ch = str(b64decode("QGNob3VtaXN0"))[2:15]
gc = str(b64decode("QGxwbV9qdWFsYW5fa2Vic29z"))[2:17]
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**𝗞𝗔𝗪𝗔𝗜𝗜-Userbot v`{BOT_VER}` is back up and running!**\n\n"
        f"**Telethon:** `{vsc}`\n"
...
with bot:
    try:
        ...
        main_help_button = [
            ...
            [
                Button.inline(get_string("help_2"), data="ub_modul_"),
            ],
            [
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    title="whats?",
                    description="𝗞𝗔𝗪𝗔𝗜𝗜-Userbot",
                    url="https://t.me/kkathrin",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
                        "image/jpeg",
...
""")
        ...
        LOGS.info(
            f"Jika mengalami error saat pemasangan silahkan klik save dipojok kanan bawah logs lalu hubungi @ijanda atau ke @ixallsupport. 𝗞𝗔𝗪𝗔𝗜𝗜-Userbot {BOT_VER}")
